var app = angular.module('customTable', ['tableAlmightyApp', "pathgather.popeye"]);


app.controller('myModalCtrl', function($scope, person){
    $scope.person = person;
})

app.controller('customTableCtrl', function ($scope, $http, Popeye) {
    ...
    $scope.generateViewInExpandedPortion = function (rowId) {
        var rowData;
    ...
    $scope.tableConfig = {
        ...
        rowActions: [
            ...
            { toolTip: 'Open popup', FAIcon: 'fa-plus-circle', text: 'Open popup ', fn: $scope.generateViewInExpandedPortion }
        ],
        tableActions: [
            {
